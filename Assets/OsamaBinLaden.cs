...
public class OsamaBinLaden : MonoBehaviour
{
    ...
    private void Awake()
    {
        Debug.Log("BIN LADEN HATH AWOKEN");
    ...
    private void AttackPlayer()
    {
        ...
        {
            //Attack code here
            GameObject plane = Instantiate(projectile, transform.position, Quaternion.identity);
            plane.GetComponent<Rigidbody>().AddForce(transform.forward * 100f, ForceMode.Impulse);
